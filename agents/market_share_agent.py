...
market_share_agent = research_agent(
    ...
    instructions=(
        ...
        "table = empty.\n"
        "5) You need market SHARE (%), NOT exact revenues. Do NOT chase one company's precise "
        "revenue through its filings / IR PDFs to back-calculate share -- it's out of scope and "
        "burns the whole budget on a single name. If a published share isn't in the snippets "
        "after a couple of searches, drop that company or leave shares EMPTY.\n"
